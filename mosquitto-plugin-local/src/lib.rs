...
impl MosquittoClientContext for MosquittoClient {
    ...
    fn get_protocol(&self) -> MosquittoClientProtocol {
        ...
        unsafe {
            ...
            if protocol == mosquitto_protocol_mp_mqtt as u32 {
                MosquittoClientProtocol::Mqtt
            } else if protocol == mosquitto_protocol_mp_mqttsn as u32 {
                MosquittoClientProtocol::MqttSn
            } else if protocol == mosquitto_protocol_mp_websockets as u32 {
